...
import { Github, Linkedin, Mail, Twitter, Calendar, Clock, Search, Download, ExternalLink, ChevronDown, Moon, Sun } from 'lucide-react';
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="flex justify-center space-x-6 mt-12">
            <a href="#" className={`p-3 rounded-lg transition-colors duration-200 ${
              darkMode ? 'text-gray-400 hover:text-white hover:bg-gray-800' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'
            }`}>
            ...
            <div className="md:col-span-2">
              <div className={`prose prose-lg ${darkMode ? 'prose-invert' : ''} max-w-none`}>
                <p className={`text-lg leading-relaxed mb-6 ${
                  ...
                  that drive business results.CurrentlyI'mpursuing an MBA at the University of Chicago Booth School of Business to further elevate my leadership and strategic decision-making skills.
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a 
              href="mailto:hello@chintapatel.com" 
              className={`flex items-center px-6 py-3 rounded-lg transition-all duration-300 transform hover:-translate-y-1 ${
                darkMode 
                  ? 'bg-white text-gray-900 hover:bg-gray-100' 
                  : 'bg-gray-900 text-white hover:bg-gray-800'
              }`}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className={`mb-6 ${
              ...
              Subscribe to get my latest articles and insights delivered directly to your inbox.
            </p>
